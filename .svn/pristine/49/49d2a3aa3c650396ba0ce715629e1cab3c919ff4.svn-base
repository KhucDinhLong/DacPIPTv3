...
namespace PIPT
{
    public partial class frmReportFactory : Form
    {
        #region Instance of the form
        /// <summary>
        /// Instance to store instance of this form
        /// </summary>
        private static frmReportFactory _instance = null;

        /// <summary>
        /// Instance form.
        /// </summary>
        /// <returns>Instance of this Form</returns>
        public static frmReportFactory Instance()
        {
            if (_instance == null || _instance.IsDisposed)
            {
                _instance = new frmReportFactory();
            }
            return _instance;
        }

        public static frmReportFactory Instance(Form parent)
        {
            _instance = Instance();
        ...
        public static frmReportFactory Instance(Form parent, bool isActivate)
        {
        ...
        private void simpleButtonGetData_Click(object sender, EventArgs e)
        {
            ...
            dacDb.AddParameter("@FactoryCode", textEditCustomerCode.Text);
            ...
            switch (comboBoxEditChooseType.SelectedIndex)
            {
                case 0: // Xuat ra the ma qrcodestring sProductCode = string.Empty;
                    dataTableAgency = dacDb.ExecuteDataTable("dbo.spDacDistributeToFactory_SelectJoin");
                    break;
                case 1: // Xuat ra theo so luong
                    dataTableAgency = dacDb.ExecuteDataTable("dbo.spDacDistributeToFactory_SelectQuantity");
                    break;
            }
        ...
        private void frmReportFactory_Load(object sender, EventArgs e)
        {
