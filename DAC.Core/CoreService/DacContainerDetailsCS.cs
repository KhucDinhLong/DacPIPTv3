...
namespace DAC.Core
{
    public class DacContainerDetailsCS
    {
        ...
        public List<DacContainerDetails> GetContainerDetails(int iContainerID)
        {
            List<DacContainerDetails> dacContainerDetailsCollection = new List<DacContainerDetails>();
        ...
        public List<DacContainerDetails> GetContainerDetails(string sPackageCode)
        {
            List<DacContainerDetails> dacContainerDetailsCollection = new List<DacContainerDetails>();
            DacDbAccess dacDb = new DacDbAccess();
            dacDb.CreateNewSqlCommand();
