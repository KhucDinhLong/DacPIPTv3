...
namespace DAC.Core
{
    ...
    {
        public List<DacStore> GetListStore()
        {
            List<DacStore> dacStoreCollection = new List<DacStore>();
            ...
            while (reader.Read())
            {
                ...
                dacStore.CreatedUser = reader["ModifiedDate"].ToString();
                dacStore.CreatedUser = reader["ModifiedUser"].ToString();
        ...
        public List<DacStore> GetListStore(string sCode, string sName, string sMobileNum)
        {
            List<DacStore> dacStoreCollection = new List<DacStore>();
            DacDbAccess dacDb = new DacDbAccess();
            dacDb.CreateNewSqlCommand();
        ...
        public List<DacStore> GetListStore(string sAgencyCode)
        {
            List<DacStore> dacStoreCollection = new List<DacStore>();
            DacDbAccess dacDb = new DacDbAccess();
            dacDb.CreateNewSqlCommand();
        ...
        public List<DacStore> GetListStore( int iID, string sAgencyCode)
        {
            List<DacStore> dacStoreCollection = new List<DacStore>();
            DacDbAccess dacDb = new DacDbAccess();
            dacDb.CreateNewSqlCommand();
