...
namespace PIPT
{
    public partial class frmReportWarehouse : Form
    {
        #region Variables
        IDacInsertToWarehouseService _importService;
        List<DacInsertToWarehouseVM> LstInfo;
        #endregion
        public frmReportWarehouse(IDacInsertToWarehouseService importService)
        {
            InitializeComponent();
        ...
        private void btnGetData_Click(object sender, EventArgs e)
        {
            ...
            LstInfo = _importService.GetAll()?.ResponseData;
            if (LstInfo != null)
            {
        ...
        private void gvReport_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            {
                frmImportDetailReport frmDetail = new frmImportDetailReport(_importService);
                frmDetail.importInfo = LstInfo[e.RowHandle];
