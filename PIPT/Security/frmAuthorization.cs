...
namespace PIPT
{
    public partial class frmAuthorization : Form
    {
        ...
        {
            // Lưu nhật ký
            CommonBO.Instance().TraceLogEvent("Update Group-Menu: " + CommonBS.CurrentUser.LoginID, CommonBS.CurrentUser.LoginID);
            Common objCommon = new Common();
            objCommon.CurrentForm = this;
            objCommon.CurrentFormMethodInvoker = SaveAuthorization;
        ...
        private void SaveAuthorization()
        {
            ...
            ucDataButtonAuthorization.DataMode = DataState.View;
        }
