...
namespace PIPTWeb.Select2 {
    public partial class Select2<TItem, TSource> : ComponentBase where TSource : IEnumerable<TItem> {
        ...
        private const string JS_COMMAND_PREFIX = "OneApp_BlazorSelect2Component";
        ...
        private object getCacheKey(string id) => new { Namespace = "OneApp.Select2", Type = "SearchCache", Select2Id = inputGuid, ObjId = id };
